...
# 直接指定目录
python run_reviewer.py --dir output/tiles/sample1
```
...
# Ubuntu / Debian
sudo apt-get update
sudo apt-get install openslide-tools python3-openslide python3-tk
